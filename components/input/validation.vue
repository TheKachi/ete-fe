  ...
  <div class="">
    <div>
      ...
      >
        ...
        <span>
          Field must have at least {{ field.$params.minLength.min }} letters.
        </span>
      </div>
      ...
      >
        ...
        <span>
          Field should be less than {{ field.$params.maxLength.max }}.
        </span>
      </div>
      ...
      <div class="error" v-if="field.email !== undefined && !field.email">
        ...
        <span> Must be a valid email (name@example.com) </span>
      </div>
      ...
      >
        ...
        <span>
          Amount should not be less than ₦{{
            $helper.numberFormat(field.$params.minValue.min)
          }}
        </span>
      </div>
