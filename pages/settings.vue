<template>
  <div class="h-full pt-80">
    <div class="">
      ...
      <div class="fixed top-80 z-[50]">
        ...
        >
          ...
          <button
            ...
            :class="[
              tab === 'bank' ? 'bg-dark text-white' : 'bg-tab text-grey',
            ]"
          >
            Bank Details
          </button>
          ...
          <button
            ...
            :class="[
              tab === 'user' ? 'bg-dark text-white' : 'bg-tab text-grey',
            ]"
          >
            User Management
          </button>
      ...
      <div class="lg:mt-28 settings overflow-y-scroll h-[800px]">
        <div v-if="tab === 'profile'">
          <div
            class="grid lg:grid-cols-12 gap-y-32 gap-x-60 mt-28 mb-36 settings overflow-y-scroll"
          >
          ...
          >
            ...
            <div class="lg:col-span-6 lg:col-end-12 gap-y-24">
              ...
              <div class="float-right flex flex-col">
                ...
                <button
                  class="click-btn my-32 lg:my-60"
        ...
        <div v-if="tab === 'user'">
          <div
            class="grid lg:grid-cols-12 mt-28 mb-36 settings overflow-y-scroll"
          >
